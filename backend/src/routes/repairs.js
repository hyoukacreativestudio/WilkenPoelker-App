...
router.get(
  '/all',
  authenticate,
  authorize(ROLES.ADMIN, ROLES.SUPER_ADMIN, ROLES.SERVICE_MANAGER, ROLES.BIKE_MANAGER, ROLES.CLEANING_MANAGER, ROLES.MOTOR_MANAGER, ROLES.ROBBY_MANAGER, ROLES.SALES_MANAGER),
